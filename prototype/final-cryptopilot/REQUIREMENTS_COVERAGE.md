...
| Area | Included |
|---|---|
| Authentication | Email + password, SMS OTP while 2FA is enabled, invalid-code state, session security |
...
| Security | Argon2/JWT/SMS OTP, AES-GCM at rest, TLS, IP allowlist, futures-only/no-withdrawal keys, session revocation and backup status |
