...
1. **Secure sign-in — Healthy.** Owner credentials proceed to SMS OTP while 2FA is enabled; invalid codes are rejected.
...
9. **Credentials, SMS, and security — Healthy.** Write-only keys, least-privilege guidance, notification templates, SMS OTP, sessions, TLS, and backups are covered.
